...
export default function AgentChat({ onModuleUnlock }: AgentChatProps) {
  ...
  return (
    <div
      className={cn(
        'flex flex-col h-screen border-l border-[var(--border)] bg-[var(--surface-soft)] transition-all duration-200',
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 py-4 border-b border-[var(--border)]">
        ...
        <button
          ...
          className="p-1 rounded hover:bg-[var(--surface-strong)] text-[var(--muted-foreground)] transition-colors"
        >
          <ChevronRight
            size={14}
        ...
        <>
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                <Bot size={32} className="text-[var(--primary)] mb-3 opacity-60" />
          ...
          <div className="p-3 border-t border-[var(--border)]">
            <div className="flex gap-2 items-end">
              <textarea
                className="flex-1 resize-none rounded-lg bg-[var(--surface-strong)] border border-[var(--border)] px-3 py-2 text-sm text-[var(--foreground)] placeholder-[var(--muted-foreground)] focus:outline-none focus:border-[var(--primary)] transition-colors min-h-[36px] max-h-32"
              ...
              <button
                ...
                className="p-2 rounded-lg bg-[var(--primary)] text-white disabled:opacity-40 hover:opacity-90 transition-opacity"
              >
                <Send size={14} />
              </button>
            </div>
